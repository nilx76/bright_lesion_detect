...
%   Detailed explanation goes here
    ...
    threshold_value_bg = 9;
    exudate_candidate = background_removed > threshold_value_bg; % Convert to binary array
    ...
    edge_candidate = exudate_edge > edge_threshold_value;
    ...
    edge_ves_removed = edge_ves_removed > 0;
    ...
    recon_marker = bitand(edge_ves_removed, fov_mask);
